 ...
 * Author: danpost<br>Version: January 13, 2013 (v2.0)<br><br>
 ...
 * will be raised to the nearest odd values to center the main actor.<br><br>
 * 
...
public class SWorld extends World
{
    ...
    private void scrollBackground()
    {
        ...
        image.drawImage(background, (getWidth()*getCellSize()-background.getWidth())/2-scrolledX*getCellSize(),
                                    (getHeight()*getCellSize()-background.getHeight())/2-scrolledY*getCellSize());
        setBackground(image);
    }
