   ...
   public void act() 
    {
        ...
        if(Greenfoot.isKeyDown("enter") && InstruçõesSelected){
            Greenfoot.setWorld(new Instruçoes()) ;
        }       
        ...
        if(InstruçõesSelected){
            setImage("InstruçoesSelected.png");
            }
            else if(!InstruçõesSelected){
            setImage("InstruçoesNonSelected.png");
        }
    }  
